...
public class ModCritical extends ModBoolean {
    public static ModCritical modCritical = new ModCritical("BonusCrit", EnumChatFormatting.WHITE.toString(), StatCollector.translateToLocal("materialtraits.critical"));
