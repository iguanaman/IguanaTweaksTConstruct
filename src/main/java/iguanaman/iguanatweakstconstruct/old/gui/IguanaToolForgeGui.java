...
public class IguanaToolForgeGui extends IguanaToolStationGui
{
	...
	public IguanaToolForgeGui(InventoryPlayer inventoryplayer, ToolForgeLogic stationlogic, World world, int x, int y, int z)
	{
...
/*
	...
	protected void actionPerformed (GuiButton button)
	{
		...
		((GuiButton) buttonList.get(selectedButton)).enabled = true;
